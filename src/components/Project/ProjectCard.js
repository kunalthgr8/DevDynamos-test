...
const ProjectCard = (props) => {
    ...
    return (
        <motion.div
            ...
            animate={{background : isHovering ? "#16446F" : "", boxShadow: isHovering ? "-2px -2px 2px 0px white" : "0"}}>
            <motion.h1 
            className='project-title'
            animate={{background: isHovering ? "#16446F" : "gray"}}>{props.title}</motion.h1>
            ...
            transition={{ ease: "linear" }}>
                ...
                <motion.button className='project-btn' animate={{width: isHovering ? "50%" : "40%", boxShadow: isHovering ? "0px 3px 5px 0px black" : ""}} transition={{delay: 0.5}}>Try Now</motion.button>
            </motion.div>
            </div>
        </motion.div>
    );
